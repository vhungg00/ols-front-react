...
const BlogMain = loadable(() => import('@/components/Admin/BlogMain'));

const Footer = loadable(() => import('@/components/FooterWrap'), {
  resolveComponent: (components) => components.FooterWrap
})
