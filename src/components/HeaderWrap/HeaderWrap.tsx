  ...
  const menus: Menu[] = [
    {
      id: '000',
      title: 'OnlineShop',
      urlPath: `${RoutePaths.home}`
    },
    {
      id: '001',
      title: 'Sản phẩm',
      urlPath: `${RoutePaths.shop}`
    },
    {
      id: '002',
      title: 'Bài viết',
      urlPath: `${RoutePaths.blog}`
    },
    {
      id: '003',
      title: 'Liên hệ',
      urlPath: `${RoutePaths.contact}`
    },
  ]
          ...
          <div className="navbarTop-inner flex flex-between flex-center">
            ...
            <div className="navbarTop-right">
              <div className="customerBox">
                <ul className="flex">
                  <li>
                    <Link to={RoutePaths.login} className="fs-14">
                      <span>Đăng nhập</span>
                    </Link>
                  </li>
                  <li>
                    <Link to={RoutePaths.signup} className="fs-14">
                      <span>/Đăng ký</span>
                    </Link>
                  </li>
                </ul>
